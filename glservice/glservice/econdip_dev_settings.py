...
LAUNCH_METHOD = 'POST'
LAUNCH_URL = '/econlaunch/toolLaunch/'
TPI_SHARED_SECRET = "test"
APP_REDIRECT_URL = "/app"     # please to exclude trailing slash!!!
APP_REDIRECT_URL_CA = "/ca/"
APP_REDIRECT_URL_UE = "/unemployment/"
...
SECRET_KEY = '0*__gf=@7zt%$@oy$ne6na=%je0(!l-u05hca9qld9@iqi63dz'
...
ROOT_URLCONF = 'glservice.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'glservice.wsgi.application'
